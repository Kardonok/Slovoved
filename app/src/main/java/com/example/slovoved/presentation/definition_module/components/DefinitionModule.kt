...
@Composable
fun DefinitionModule(word:String, definition: String, bookmarkIsActive: Boolean,navController: NavHostController?=null) {
    Scaffold(bottomBar = { FunctionalBar(word=word,bookmarkIsActive=bookmarkIsActive,navController=navController) },
        content = {padding->
            LazyColumn(contentPadding = padding) {
                item {
                    Text(text = definition, style = textStyle, modifier = Modifier.padding(16.dp))
                }
